...
def user_agent (ver):
    ...
    if ver == 'ep9':
        bzz =(
        'EEA Update (macOS; U; 64bit; BPC 9.0.12317.0; OS: 6.1.7601 SP 1.0 NT; TDB 67467; CL 0.0.0; x64s; APP eea; PX 0; PUA 0; CD 1; RA 0; UNS 0; HVCI 0; SHA256 1; WU 2; ACS 0; TDT 0; LTS 0; NPU 0; HWF: 010070B9-CE54-B37C-736B-42F0927552D3; PLOC ru_ru; PCODE 211.0.0; PAR -1; ATH -1; DC 0; PLID ; SEAT 154b3474; RET 5003)',
        'EEA Update (macOS; U; 64bit; BPC 9.0.12317.0; OS: 6.1.7601 SP 1.0 NT; TDB 67467; CL 0.0.0; x64s; APP eea; PX 0; PUA 0; CD 1; RA 0; UNS 0; HVCI 0; SHA256 1; WU 2; ACS 0; TDT 0; LTS 0; NPU 0; HWF: 010062B8-AB45-B26C-626B-41F0917542D5; PLOC ru_ru; PCODE 211.0.0; PAR -1; ATH -1; DC 0; PLID ; SEAT 123b3474; RET 5003)',
        )
        return random.choice(bzz)
    ...
    if ver == 'ep12':
        bzz =(
        'EFSW Update (Windows; U; 64bit; BPC 12.0.12005.0; OS: 10.0.14393 SP 0.0 NT; TDB 67229; CL 0.0.0; x64s; APP efsw; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 8868; HVCI 0; SHA256 1; WU 3; uPCU 12.1.12012.0; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 010030ED-055B-53C3-A787-846CE455A0F4; PLOC ru_ru; PCODE 211.0.0; PAR -1; ATH -1; DC 0; PLID 33D-58A-6KA; SEAT 154b3474; RET 2101)',
        'EFSW Update (Windows; U; 64bit; BPC 12.0.12005.0; OS: 10.0.14393 SP 0.0 NT; TDB 68715; CL 0.0.0; x64s; APP efsw; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 8868; HVCI 0; SHA256 1; WU 3; uPCU 12.1.12012.0; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 010030ED-055B-53C3-A787-846CE455A0F4; PLOC ru_ru; PCODE 211.0.0; PAR -1; ATH -1; DC 0; PLID 33D-58A-6KA; SEAT 154b3474; RET 0)',
    ...
    if ver == 'ep13':
        bzz =(
        'EEA Update (Windows; U; 64bit; BPC 13.0.2044.0; OS: 10.0.19044 SP 0.0 NT; Mirror; TDB 69071; CL 0.0.0; x64c; APP eea; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 7058; HVCI 0; SHA256 1; WU 3; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 02007B1B-E2AC-2B18-22EA-0181927E4F09; PLOC ru_ru; PCODE 107.0.0; PAR -1; ATH -1; DC 0; PLID 2AC-8SP-9D9; SEAT 144b3474; RET 2103)',
        'EEA Update (Windows; U; 64bit; BPC 13.0.2044.0; OS: 10.0.19044 SP 0.0 NT; Mirror; TDB 69071; CL 0.0.0; x64c; APP eea; PX 0; PUA 1; CD 0; RA 0; UNS 1; UBR 7058; HVCI 0; SHA256 1; WU 3; ACS 1; TDT 0; LTS 1; NPU 0; HWF: 04107A1B-E4AC-2B18-24BA-0281727E4F08; PLOC ru_ru; PCODE 107.0.0; PAR -1; ATH -1; DC 0; PLID 2BC-7SP-7D3; SEAT 124b4452; RET 2103)',
            )
        return random.choice(bzz)
